...
import (
	...
	"Im-chat/Chat/apps/user/rpc/internal/logic"
...
func (s *UserServer) FindUsers(ctx context.Context, in *user.FindUserReq) (*user.FindUserResp, error) {
	l := logic.NewFindUsersLogic(ctx, s.svcCtx)
	return l.FindUsers(in)
}
