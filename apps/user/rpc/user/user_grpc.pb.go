...
const (
	...
	User_FindUsers_FullMethodName   = "/user.User/FindUsers"
)
...
type UserClient interface {
	...
	FindUsers(ctx context.Context, in *FindUserReq, opts ...grpc.CallOption) (*FindUserResp, error)
}
...
func (c *userClient) FindUsers(ctx context.Context, in *FindUserReq, opts ...grpc.CallOption) (*FindUserResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServer interface {
	...
	FindUsers(context.Context, *FindUserReq) (*FindUserResp, error)
...
func (UnimplementedUserServer) FindUsers(context.Context, *FindUserReq) (*FindUserResp, error) {
...
func _User_FindUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).FindUsers(ctx, req.(*FindUserReq))
	}
	return interceptor(ctx, in, info, handler)
}
